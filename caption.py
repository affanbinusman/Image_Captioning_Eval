...
#     parser.add_argument('--dont_smooth', dest='smooth', action='store_false', help='do not smooth alpha overlay')
    ...
    word_map = "./flikr_out/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json"
    beam_size = 5
    ...
    with open('v2_800.csv', mode="r") as csv_file: #"r" represents the read mode
        reader = csv.reader(csv_file)

        for item in reader:
            
            if item[2] == 'url_data':
                with open('v3_800.csv', 'a') as new_csv:  
            ...
            # img_path = "eval_images/" + img.split("/")[-1]
            ...
            with open('v3_800.csv', 'a') as new_csv:  
                writer = csv.writer(new_csv)
                writer.writerow([caption, item[1], item[2]])  
